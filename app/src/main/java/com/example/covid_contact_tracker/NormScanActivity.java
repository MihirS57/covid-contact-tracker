...
public class NormScanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_norscan );
    ...
    private final BroadcastReceiver receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Toast.makeText( NormScanActivity.this, "Receiving", Toast.LENGTH_SHORT ).show();
    ...
    public void BleDiscover(View v){
        Intent launchBle = new Intent( NormScanActivity.this,BLEScanActivity.class);
    ...
    public void addToDiscoveredList(String name, String Bclass,String mac, short rssi){
        ...
        if(name!=null){
            ...
            Toast.makeText( NormScanActivity.this, "Almost there", Toast.LENGTH_SHORT ).show();
        }
